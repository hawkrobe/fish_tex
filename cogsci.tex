...
We are grateful to Colin Torney for providing the code to make the score field gradients.
...
RH, PK, AP, NG, and JT formulated  the study. RH and PK designed the experiments, implemented the experiments, and analyzed the data. HF assisted with data analysis. RH, PK, and AB wrote the manuscript. PK is the acknowledged head of the writing team. All authors gave final approval for publication and agree to be held accountable for the work performed therein.
