...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{./figures/experiment1_design.pdf}
  \hspace{0.1cm}
  \caption{Multi-agent tracking task used in Exp. 1.}
  \label{fig:score}
\end{figure}
...
\todo[inline]{rdh: need to describe how we handled participant disconnects/removals (i.e. allowed the smaller group to continue) and how we assigned group sizes, e.g. were group sizes sampled randomly?}
