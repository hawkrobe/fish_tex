...
Computational simulations \cite<e.g.>{schlag1998imitate,lazer2007network,rendell_why_2010} and human experiments \cite{mason2008propagation,mesoudi2008experimental,mason2012collaborative} typically provide agents the ability to directly observe the underlying payoffs of different agents.
...
While it is possible that associative learning allows agents to adopt particular external cues as proxies (e.g. visible health or wealth), social inference mechanisms may provide a more flexible alternative, especially in groups of humans. 

The ability to make inferences about the hidden success and knowledge of other agents, or the information likely to be motivating their decisions, has been extensively studied in cognitive science.
Even young children are able to rapidly infer which partners are more trustworthy and knowledgeable than others, and prefer to learn from them \cite{wood2013whom,sobel2013knowledge,gweon2014sins,poulin2016developmental,harris2018cognitive,mills2016learning}, and adults can appropriately discount unreliable social information into their decision-making \cite{velez2019integrating}.
However, this literature  has largely developed independently from work on social learning strategies in collectives.
Previous work has suggested that inferences about underlying cues may prevent costly and erroneous cascades \cite{bikhchandani1998learning,giraldeau2002potential}, but the broader implications of social inference abilities for collective intelligence remains unclear.
...
% We aim to examine how people make use of theory of mind, an ability to draw inferences about the underlying mental states of other players, to
...
This is similar in some ways to collective foraging tasks \cite<e.g.>{dechaume2005hidden,goldstone2005knowledge}, but the `resource' is not consumable so there are no competitive dynamics.
