...
\begin{figure}
    ...
    \todo[inline]{ TODO:  maybe better explain the x-axis and the legend; e.g. what does 'stopped' mean(is it human participant stop? or bot stop?) what does 'receiving reward' mean? is it bot receiving reward, or human participant? (i.e. "participant currently" looks like a title rather than part of legend.)}
    \label{fig:proximity}
\end{figure}
...
\todo[inline]{rdh: this can be simplified to just describe differences from exp. 1 (i.e. a lot of procedural things are redundant here)}
\begin{figure}
  \centering
